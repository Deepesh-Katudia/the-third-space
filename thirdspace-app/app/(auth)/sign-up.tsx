...
{/*.......*/}
<TouchableOpacity onPress={handleAppleSignUp} style={{ alignItems: 'center', paddingVertical: 8 }}>
    <Text style={{ fontFamily: 'DMSans_400Regular', fontSize: 13, color: '#8C7B70', textDecorationLine: 'underline' }}>

...
const styles = StyleSheet.create({
  ...
  heading: { fontFamily: 'DMSerifDisplay_400Regular', fontSize: 30, color: '#2C1810', letterSpacing: -0.5, marginBottom: 10 },
  subtitle: { fontFamily: 'DMSans_400Regular', fontSize: 15, color: '#8C7B70', lineHeight: 22, marginBottom: 28 },
  perks: { gap: 16 },
  perk: { flexDirection: 'row', alignItems: 'flex-start', gap: 14, backgroundColor: 'white', borderRadius: 16, padding: 16, borderWidth: 1, borderColor: 'rgba(242,197,160,0.5)' },
  perkIcon: { fontSize: 24 },
  perkText: { flex: 1 },
  perkTitle: { fontFamily: 'DMSans_500Medium', fontSize: 15, color: '#2C1810', marginBottom: 3 },
  perkBody: { fontFamily: 'DMSans_400Regular', fontSize: 13, color: '#8C7B70', lineHeight: 19 },
  error: { fontFamily: 'DMSans_400Regular', fontSize: 13, color: '#dc2626', marginTop: 16 },
  footer: { paddingHorizontal: 24, paddingBottom: 12 },
  footnote: { fontFamily: 'DMSans_400Regular', fontSize: 12, color: '#8C7B70', textAlign: 'center', marginTop: 12, lineHeight: 18 },
})
